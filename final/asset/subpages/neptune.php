...
<body>
    ...
    <div id="pi-div"><img class="page-image" src="../images/neptune-rotating.gif" alt="neptune rotating"></div>
    ...
    <div class="container">
        ...
        <section id="Fun-Fact">
           ...
           <ul>
            ...
            <li>Neptune is 2.7 billion miles (4.3 billion km) away when it is closest to Earth and 2.8 billion miles (4.5 billion km) when it is the furthest from Earth.</li>
            <li>One year on Neptune is equal to 165 Earth years.</li>
            <li>Number of Moons : 14</li>
            <li>Gravity of 11.15 m/s2</li>
            <li>Ice Giant</li>
           </ul>
        ...
        <!-- <section id="planets">
            <img src="../images/neptune-rotating.gif">
         </section> -->
