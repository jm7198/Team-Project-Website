...
<body>
    ...
    <div class="container">
        <section id="Description">
            <h2>Description</h2>
            <p>The Sun is the star at the center of the Solar System. It is a nearly perfect ball of hot plasma, heated to incandescence by nuclear fusion reactions in its core, radiating the energy mainly as light, ultraviolet, and infrared radiation. It is the most important source of energy for life on Earth.
        ...
        <section id="Fun-Fact">
            <h2>Fun Fact</h2>
            <ul>
                <li>Size ≈ 700,000km</li>
                <li>Distance from Earth ≈ 149,600,000km</li>
                <li>The Sun is by far the brightest object in the Earth's sky, with an apparent magnitude of −26.74. This is about 13 billion times brighter than the next brightest star, Sirius, which has an apparent magnitude of −1.46
                </li>
                <li>Age ≈ 4.6 billion years</li>
                <li>Gravity - 28 × Earth</sup></li>
                <li>Mass - 1.9885×1030 kg</li>
        ...
        <section id="Atmostphere">
            <h2>Atmostphere</h2>
            <p>During a total solar eclipse, when the disk of the Sun is covered by that of the Moon, parts of the Sun's surrounding atmosphere can be seen. It is composed of four distinct parts: the chromosphere, the transition region, the corona and the heliosphere.
        ...
        <section id="Geology">
            <h2>Composition</h2>
            <p>The Sun is composed primarily of the chemical elements hydrogen and helium. At this time in the Sun's life, they account for 74.9% and 23.8%, respectively, of the mass of the Sun in the photosphere. All heavier elements, called metals in astronomy, account for less than 2% of the mass, with oxygen (roughly 1% of the Sun's mass), carbon (0.3%), neon (0.2%), and iron (0.2%) being the most abundant.
