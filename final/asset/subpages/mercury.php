...
<body>
    ...
    <div id="pi-div"><img class="page-image" src="../images/mercury-rotating.gif" alt="Mercury rotating"></div>
    ...
    <div class="container">
        ...
        <section id="Fun-Fact">
            <h2>Fun Fact</h2>
           <ul>
            <li>Size - 3.3011x1023 kg </li>
            <li>Distance from Earth - 77 million km to 222 million km </li>
            <li> It takes 87.969 Earth days for Mercury to complete its orbit.</li>
            <li>Number of Moon : None</li>
            <li>Gravity - 3.7 m/s2</li>
            <li>Terrestrial</li>
            <li>Atmostphere - None</li>
           </ul>
        </section>
