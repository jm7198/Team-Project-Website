...
<body>
    ...
    <div class="container">
        ...
        <section id="Fun-Fact">
            ...
            <ul>
                <li>Size - 3396.2km</li>
                <li>Closest - 54.6 million km, Farthest - 401.4 km</li>
                <li>As of 2022, Mars is host to fourteen functioning spacecraft. Eight are in orbit: 2001 Mars Odyssey, Mars Express, Mars Reconnaissance Orbiter, MAVEN, ExoMars Trace Gas Orbiter, the Hope orbiter, and the Tianwen-1 orbiter. Another six are on the surface: the InSight lander, the Mars Science Laboratory Curiosity rover, the Perseverance rover, the Ingenuity helicopter, the Tianwen-1 lander, and the Zhurong rover.</li>
                <li>Gravity - 3.72076 m/s2</li>
                <li>Terrestrial</li>
