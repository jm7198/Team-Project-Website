...
<body>
    ...
    <ul>
        ...
        <li>For the Earth and Saturn, the distance of closest approach is about **1.2 billion kilometers **and the distance of farthest approach is about 2.85 billion kilometers.</li>
        <li>A year on Saturn is more than 29 Earth years. Saturn spins on its axis very fast. A day on Saturn is 10 hours and 14 minutes.</li>
        <li>Number of Moons : 83</li>
        <li>Gravity - 10.44 m/s2</li>
        <li>Gas Gaint</li>
    </ul>
        </section>
