...
<body>
    ...
    <div id="pi-div"><img class="page-image" src="../images/uranus-rotating.gif" alt="uranus rotating"></div>
    ...
    <div class="container">
        ...
        <section id="Fun-Fact">
            <h2>Fun Fact</h2>
            <ul>
                <li>25,362±7 km mean radius. 4 times wider than earth.  </li>
                <li>The closest Uranus can get to Earth is 2.57 billion km, farthest is  3.15 billion km.</li>
                <li>Uranus had been observed on many occasions before its recognition as a planet, but it was generally mistaken for a star.</li>
                <li>Number of Moons: 27</li>
                <li> Surface Gravity 8.69 m/2</li>
                <li>Ice Planet</li>
            </ul>
        </section>
        ...
        <!-- <section id="planets">
            <img src="../images/uranus-rotating.gif">
         </section> -->
